...
=============================================
Describe the music you're in the mood for:
> uplifting songs to boost focus in the gym

[1/3] Parsing your description...
      Detected: genre=pop, mood=focused, energy=0.9, acoustic=False
...
#1  Stronger — Kanye West
    Score : 3.00
    Why   : The relentless electronic beat and empowering lyrics create an unstoppable, high-energy drive to power through tough workouts.

#2  Pump It — The Black Eyed Peas
    Score : 2.99
    Why   : Its relentless high-energy beat and aggressive tempo deliver an immediate surge of adrenaline to lock in your focus.

#3  Power — Kanye West
    Score : 2.98
    Why   : 'Power' delivers a relentless, high-energy beat that drives maximum intensity, keeping you relentlessly focused through every grueling rep.

#4  Gym Hero — Max Pulse
    Score : 2.97
    Why   : Max Pulse's intense pop track 'Gym Hero' delivers an energetic rhythm that instantly supercharges your workout focus.

#5  Titanium — David Guetta ft. Sia
    Score : 2.95
    Why   : Sia’s soaring vocals and the high-energy beat create an unstoppable, empowering anthem that fuels intense gym focus.
